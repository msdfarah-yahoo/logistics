...
if(isset($_POST['submit']))
{
    $sdate=$_POST['sdate'];
    $edate=$_POST['edate'];
    $sql=mysqli_query($conn,"select * from qry_dispatch where Ddate between '$sdate' and '$edate' ");
    if($sql)
    {
    ?>
        <table class="table table-striped" >
            <tr><td>Ddate</td><td>Site</td><td>Line</td><td> PO</td><td> WO</td><td>Model</td><td> ItemCode</td><td>Item Name</td><td>Qty</td></tr>
            <?php 
